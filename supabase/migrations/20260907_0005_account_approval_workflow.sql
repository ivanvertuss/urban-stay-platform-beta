...
-- New accounts remain pending until an Urban Stay admin approves them.
...
-- Admins can review all profiles; owners still only see their own profile
-- through the existing profiles_select_own policy.
...
-- Account state and role are never writable directly from the browser.
...
-- Admins may inspect the full moderation audit trail.
